# Gravity Forms Multi Uploader
Welcome to the GF-Multi-Uploader repository on GitHub.
...
If you are not a developer, please use the [GF-Multi-Uploader plugin page](https://wordpress.org/plugins/gravity-forms-multi-uploader/) on WordPress.org.
...
place through the appropriate channel on [our community forum on wp.org](https://wordpress.org/support/plugin/gravity-forms-multi-uploader/).
