...
plupload.addI18n({
  ...
  "Size": "Розмір",
  "Close": "Закрити",
  "You must specify either browse_button or drop_element.": "Ви маєте вказати або browse_button, або drop_element.",
  ...
  "%s specified, but cannot be found.": "%s вказано, але не може бути знайдено.",
  ...
  "Resoultion out of boundaries! <b>%s</b> runtime supports images only up to %wx%hpx.": "Роздільна здатність поза межами! Робоче середовище <b>%s</b> підтримує зображення лише до %wx%hpx.",
  "File: %s": "Файл: %s",
  "b": "б",
