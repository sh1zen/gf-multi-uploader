...
plupload.addI18n({
  ...
  "Size": "Boyut",
  "Close": "Kapat",
  "You must specify either browse_button or drop_element.": "browse_button veya drop_element değişkenlerini belirlemelisiniz.",
  ...
  "List": "Liste",
  "Filename": "Dosya adı",
  "%s specified, but cannot be found.": "%s tanımlandı fakat bulunamadı.",
  ...
  "Resoultion out of boundaries! <b>%s</b> runtime supports images only up to %wx%hpx.": "Çözünürlük sınırların dışındadır! <b>%s</b> modu en fazla %wx%hpx desteklemektedir.",
  "File: %s": "Dosya: %s",
  "b": "bayt",
